/// input_text_set_misc(id, clipboard pasting enabled, cursor sprite, cursor style, max undo/redo states, selection background color, selection background alpha, selection text color, selection text alpha, shaders)
