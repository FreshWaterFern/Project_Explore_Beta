/// world_generate_chunk(x,y,biome_data_list)
...
case 4:{
object_create_plant(pre_calc1+640+floor(random_range(real(temp_list[|2])-640,real(temp_list[|4])-640)),pre_calc2+640+floor(random_range(real(temp_list[|3])-640,real(temp_list[|5])-640)),item_id);
break;}
...
//object_create_plant(floor(random_range(real(temp_list[|2]),real(temp_list[|4]))),floor(random_range(real(temp_list[|3]),real(temp_list[|5]))),db_item_get_name(temp_list[|0]));
//object_create_plant(obj_player.x,obj_player.y,db_item_get_name(temp_list[|0]));
