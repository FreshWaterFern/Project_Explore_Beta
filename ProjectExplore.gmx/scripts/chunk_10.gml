...
ds_grid_set(global.world_tiles,pre_x128+4,pre_y128+6,15);ds_grid_set(global.world_tiles,pre_x128+5,pre_y128+4,15);
...
ds_grid_set(global.world_tiles,pre_x128+6,pre_y128+6,15);
...
instance_create((pre_x128+4)*128,(pre_y128+6)*128,objind(obj_world_water2));instance_create((pre_x128+5)*128,(pre_y128+4)*128,objind(obj_world_water2));
...
instance_create((pre_x128+6)*128,(pre_y128+6)*128,objind(obj_world_water2));
repeat(100)
{
