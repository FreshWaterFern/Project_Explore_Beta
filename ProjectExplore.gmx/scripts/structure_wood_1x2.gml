/// structure_wood_1x2(offset_x,offset_y,door_side,locked)
var inst = 0;var offset_x = argument0;var offset_y = argument1;
global.world_tiles[# floor((argument0/128)),floor((argument1/128))] = 8;
global.world_tiles[# floor((argument0/128)),floor((argument1/128))+1] = 8;
//if ( argument2 == "down" ){offset_y-=128;}
// Left Side
inst=instance_create(offset_x-64,offset_y+128,objind(obj_wood_wall1));inst.image_angle=90;
if ( argument2 == "left" ){
...
// Down Side
if ( argument2 == "down" ){
inst=instance_create(offset_x,offset_y+192,objind(obj_wood_doorway1));
inst=instance_create(offset_x-25,offset_y+192,objind(obj_construct_door));inst.door_construct=0;inst.door_locked=argument3;
}else{inst=instance_create(offset_x,offset_y+192,objind(obj_wood_wall1));}
// Ceiling
inst=instance_create(offset_x,offset_y,objind(obj_wood_ceiling1));
inst=instance_create(offset_x,offset_y+128,objind(obj_wood_ceiling1));
