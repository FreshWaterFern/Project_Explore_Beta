...
draw_image_ext(argument0,argument1,argument2-(temp_z*_hor),argument3-(temp_z*_ver),argument5+scale*argument5,argument6+scale*argument6,argument7,argument8,argument9)
