...
ds_grid_set(global.world_biomes,pre_x/1280,pre_y/1280,2);
...
repeat(100)
{
chance = round(random_range(1,125));
if ( chance == 5 )
{
...
world_structures(pre_x128+choose(0,1,2,3,4,5),pre_y128+choose(0,1,2,3,4,5),choose(0,1,3,8));
