...
ds_grid_set(global.world_biomes,pre_x/1280,pre_y/1280,4);
ds_grid_set_region(global.world_tiles,pre_x128,pre_y128,pre_x128+9,pre_y128+9,10);
ds_grid_set(global.world_tiles,pre_x128,pre_y128,0);ds_grid_set(global.world_tiles,pre_x128+9,pre_y128,0);
ds_grid_set(global.world_tiles,pre_x128,pre_y128+9,0);ds_grid_set(global.world_tiles,pre_x128+9,pre_y128+9,0);
ds_grid_set(global.world_tiles,pre_x128+1,pre_y128,0);ds_grid_set(global.world_tiles,pre_x128,pre_y128+1,0);
ds_grid_set(global.world_tiles,pre_x128+1,pre_y128+9,0);ds_grid_set(global.world_tiles,pre_x128,pre_y128+8,0);
ds_grid_set(global.world_tiles,pre_x128+8,pre_y128,0);ds_grid_set(global.world_tiles,pre_x128+9,pre_y128+1,0);
ds_grid_set(global.world_tiles,pre_x128+8,pre_y128+9,0);ds_grid_set(global.world_tiles,pre_x128+9,pre_y128+8,0);
var max_ai_spawn = 3;
var ai_spawn = 0;
repeat(5)
{
...
inst = instance_create((floor((r_x+i+pre_x)/32))*32,(floor((r_y+r+pre_y)/32))*32,objind(obj_plant));
inst.plant_type = choose(0,1,2);
}
...
chance = round(random_range(1,100));
if ( chance == 2 )
{
