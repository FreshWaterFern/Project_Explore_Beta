...
ds_grid_set(global.world_biomes,pre_x/1280,pre_y/1280,7);
...
chance = round(random_range(1,275));
if ( chance == 2 )
{
...
world_structures(pre_x128+choose(0,1,2,3,4,5),pre_y128+choose(0,1,2,3,4,5),choose(5,6,7));
